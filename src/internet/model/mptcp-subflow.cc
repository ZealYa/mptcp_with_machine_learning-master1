...
{
  NS_LOG_FUNCTION (this << tcpHeader);
  // std::cout<<" [node " << m_node->GetId () << ": ] "<<"still receiving data"<<endl;
...
////  std::cout<GetSubflowId()<<" "<<Simulator::Now ().GetSeconds ()<<" "<<p->GetSize()*8/1024/(Simulator::Now ().GetSeconds()-getLastReceivedDataTime())<<endl;
//  throughput_data<<GetSubflowId()<<" "<<Simulator::Now ().GetSeconds ()<<" "<<p->GetSize()*8/1024/(Simulator::Now ().GetSeconds()-getLastReceivedDataTime())<<endl;
//  std::cout<<GetSubflowId()<<" "<<Simulator::Now ().GetSeconds ()<<" "<<p->GetSize()*8/1024/(Simulator::Now ().GetSeconds()-getLastReceivedDataTime())<<endl;
//  }
//  setLastReceivedDataTime(Simulator::Now ().GetSeconds());
//
...
double MpTcpSubflow::getThpt(){
		return m_thpt;
	}

void MpTcpSubflow::setThpt(double thpt) {
	m_thpt = thpt;
}
