...
/**
\brief Defined in RFC OLIA(http://tools.ietf.org/html/rfc6356)
 OLIA (Linked Increase Algorithm)
*/
class MpTcpOLia : public TcpNewReno
{
public:
  /**
  ...
  MpTcpOLia ();
  MpTcpOLia (const MpTcpOLia& sock);
...
protected:
   ...
   */
  double ComputeFirstTerm (Ptr<MpTcpMetaSocket> metaSock, Ptr<TcpSocketState> tcb) const;
  double ComputeSecondTerm (Ptr<MpTcpMetaSocket> metaSock, Ptr<TcpSocketState> tcb) const;
