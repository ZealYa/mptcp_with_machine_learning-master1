...
//  		anim.UpdateNodeColor (client.Get(0), red.r, red.g, red.b);
//  		anim.UpdateNodeColor (server.Get(1), blue.r, blue.g, blue.b);
//  		anim.UpdateNodeColor (middle.Get(0), green.r, green.g, green.b);
//  		anim.UpdateNodeColor (other_clients.Get(0), red.r, red.g, red.b);
//  		anim.UpdateNodeColor (other_servers.Get(1), blue.r, blue.g, blue.b);
  ...
  //		 anim.SetConstantPosition(router.Get(4), 66.0, 66.0);
   anim.SetConstantPosition	(B, 0, 200);
   anim.SetConstantPosition	(C, 200, 200);
   anim.SetConstantPosition	(A, 400, 200);
   anim.SetConstantPosition	(E, 100, 0);
   anim.SetConstantPosition	(D, 500, 0);
  ...
  if(useStaticRouting == false){
    ...
    addressHelper.SetBase("192.168.12.0", "255.255.255.0");
    addressHelper.Assign(PointToPointCreate(E, C, DataRate("200Kbps"), Time("15ms"), packetSize));

    addressHelper.SetBase("192.168.13.0", "255.255.255.0");
    addressHelper.Assign(PointToPointCreate(D, A, DataRate("200Kbps"), Time("15ms"), packetSize));
  }
  else{
