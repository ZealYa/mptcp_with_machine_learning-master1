...
protected:
  ...
  virtual uint32_t get1r() const;

  virtual void set1r(uint32_t _1r);

  virtual uint32_t get2r() const;

  virtual void set2r(uint32_t _2r);
