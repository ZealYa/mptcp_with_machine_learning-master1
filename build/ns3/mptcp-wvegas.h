...
#ifndef MPTCP_CC_WVEGAS_H
#define MPTCP_CC_WVEGAS_H
...
class MpTcpWVegas : public TcpNewReno
{
public:
  /**
   ...
   */
  MpTcpWVegas (const MpTcpWVegas& sock);
  virtual ~MpTcpWVegas (void);
...
protected:
  void AdjustWeights (Ptr<MpTcpMetaSocket> metaSock);

  Ptr<MpTcpSubflow> GetSubflow (Ptr<MpTcpMetaSocket> metaSock, Ptr<TcpSocketState> tcb) const;
