...
EXAMPLE_DIRECTORIES = ['realtime', 'tcp', 'naming', 'traffic-control', 'routing', 'udp-client-server', 'error-model', 'socket', 'stats', 'udp', 'energy', 'wireless', 'tutorial', 'ipv6', 'matrix-topology']
