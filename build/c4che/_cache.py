...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-gnDdqE/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-gnDdqE/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-gnDdqE/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-gnDdqE/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['wireless', 'naming', 'tcp', 'ipv6', 'udp', 'error-model', 'stats', 'tutorial', 'realtime', 'energy', 'socket', 'udp-client-server', 'matrix-topology', 'traffic-control', 'routing']
...
NS3_EXECUTABLE_PATH = ['/home/matthew/mptcp_with_machine_learning-master1/mptcp_with_machine_learning-master/build/src/fd-net-device', '/home/matthew/mptcp_with_machine_learning-master1/mptcp_with_machine_learning-master/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/matthew/mptcp_with_machine_learning-master1/mptcp_with_machine_learning-master/build']
...
cfg_files = ['/home/matthew/mptcp_with_machine_learning-master1/mptcp_with_machine_learning-master/build/ns3/config-store-config.h', '/home/matthew/mptcp_with_machine_learning-master1/mptcp_with_machine_learning-master/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
